...
public class CustomSwitch extends SettingsPreferenceFragment {

    private RecyclerView mRecyclerView;
    private ThemeUtils mThemeUtils;
    private String mCategory = "android.customization.switch_style";
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.icon_option_switch, parent, false);
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.image1.setBackgroundDrawable(getDrawable(holder.image1.getContext(), dataPkg, "custom_switch_previewer"));
