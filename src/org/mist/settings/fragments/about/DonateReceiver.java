...
public class DonateReceiver extends BroadcastReceiver {
    ...
    public static final long COOLDOWN_MIN = 30 * 24 * 60;
    public static final long INITIAL_DELAY_MIN = 30;
    public static final long REPEAT_DELAY_MIN = 60;

    private static final String ACTION_DONATE_NUDGE = "org.mist.settings.action.DONATE_NUDGE";
    ...
    private void showDonateNotification(Context ctx) {
        ...
        NotificationCompat.Builder b = new NotificationCompat.Builder(ctx, DONATE_CHANNEL_ID)
                ...
                .setContentTitle(ctx.getString(R.string.mistos_donate_title))
                .setContentText(ctx.getString(R.string.mistos_donate_notification_text))
    ...
    private void createChannelIfNeeded(Context ctx) {
        ...
        NotificationChannel ch = new NotificationChannel(
                DONATE_CHANNEL_ID,
                ctx.getString(R.string.mistos_channel_name),
                NotificationManager.IMPORTANCE_HIGH
        );
        ch.setDescription(ctx.getString(R.string.mistos_channel_desc));
