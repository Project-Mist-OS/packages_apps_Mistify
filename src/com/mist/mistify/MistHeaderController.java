...
public class MistHeaderController extends BasePreferenceController implements View.OnClickListener {
	...
	public MistHeaderController(Context context, String key) {
		super(context, key);
	}
	...
	public void displayPreference(PreferenceScreen screen) {
		...
		mPreference = screen.findPreference("mist_header");
		aboutCard = mPreference.findViewById(R.id.mist_about_card);
		quickSettingsCard = mPreference.findViewById(R.id.mist_qspanel_card);
		statusBarCard = mPreference.findViewById(R.id.mist_statusbar_card);
	...
	public void onClick(View v) {
		if (v == aboutCard) {
			startActivity("ThemeSettingsActivity");
